    ...
    <div className="min-h-screen bg-[#F0F2F5] flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-[28px] font-bold tracking-tight text-[#0A0A0A] mb-1.5">Welcome back.</h1>
        ...
        <div className="bg-white rounded-[24px] p-8" style={{ border: '1px solid rgba(0,0,0,0.08)', boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            {/* Email */}
            <div>
              <label className="block text-[12px] font-medium text-[#6B6B6B] mb-1.5 tracking-wide">Email</label>
              <input
                type="email"
            ...
            {/* Password */}
            <div>
              <label className="block text-[12px] font-medium text-[#6B6B6B] mb-1.5 tracking-wide">Password</label>
        ...
        <p className="text-center text-[13px] text-[#6B6B6B] mt-6">
          No account?{' '}
          <Link to="/signup" className="font-semibold text-[#0A0A0A] hover:underline">
            Create one free
          </Link>
        </p>
      </motion.div>
